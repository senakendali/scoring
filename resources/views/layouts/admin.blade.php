...
<body>
    ...
    <header class="app-header d-flex justify-content-start admin">
        <div class="container-fluid d-flex justify-content-between align-items-center">
           <a href="{{ url('/') }}"><img src="{{ asset('images/admin-logo.png') }}" alt="IPSI"></a>
            ...
            <div class="dropdown ms-auto">
                ...
                @endphp
                <button class="btn btn-light dropdown-toggle btn-sm" type="button" id="userInfoDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                    {{ $roleLabel }}
                </button>
